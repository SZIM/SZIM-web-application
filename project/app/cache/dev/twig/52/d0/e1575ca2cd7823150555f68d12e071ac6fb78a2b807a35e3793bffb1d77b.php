...
class __TwigTemplate_52d0e1575ca2cd7823150555f68d12e071ac6fb78a2b807a35e3793bffb1d77b extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_d07337126b964e21ad1918ff7487426516cce8abb029376fea744b1c94923cc3"] = $this;
        // line 5
...
";
    ...
    ";
        // line 80
        echo $context["__internal_d07337126b964e21ad1918ff7487426516cce8abb029376fea744b1c94923cc3"]->getdisplay_timeline(("timeline_" . $this->getContext($context, "token")), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getContext($context, "colors"));
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "children"))) {
            ...
            ";
                // line 90
                echo $context["__internal_d07337126b964e21ad1918ff7487426516cce8abb029376fea744b1c94923cc3"]->getdisplay_timeline(("timeline_" . $this->getAttribute($this->getContext($context, "child"), "token")), $this->getContext($context, "events"), $this->getContext($context, "colors"));
                echo "
        ";
            }
...
";
        // line 406
        echo $context["__internal_d07337126b964e21ad1918ff7487426516cce8abb029376fea744b1c94923cc3"]->getdump_request_data($this->getContext($context, "token"), $this->getContext($context, "profile"), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
        echo "
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 411
                echo $context["__internal_d07337126b964e21ad1918ff7487426516cce8abb029376fea744b1c94923cc3"]->getdump_request_data($this->getAttribute($this->getContext($context, "child"), "token"), $this->getContext($context, "child"), $this->getAttribute($this->getAttribute($this->getContext($context, "child"), "getcollector", array(0 => "time"), "method"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
...
";
    ...
    public function getdump_request_data($_token = null, $_profile = null, $_events = null, $_origin = null)
    {
        ...
        try {
            // line 451
            $context["__internal_121d24e5c5375b083a1a428fb67f4cf6855618482b0853773bbb253241a473a6"] = $this;
            // line 452
            echo "                {
                    \"id\": \"";
            // line 453
...
";
            // line 456
            echo $context["__internal_121d24e5c5375b083a1a428fb67f4cf6855618482b0853773bbb253241a473a6"]->getdump_events($this->getContext($context, "events"));
            echo "
                    ]
                }
";
